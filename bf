...
MAIN_CLASS="io.tison.trufflebf.BFMain"
...
if [[ "$GRAALVM_VERSION" != "" ]]; then
    ...
    LANGUAGE_PATH="$SCRIPT_HOME/trufflebf-language/target/trufflebf-language.jar"
    LAUNCHER_PATH="$SCRIPT_HOME/trufflebf-launcher/target/trufflebf-launcher.jar"
